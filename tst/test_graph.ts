...
describe('Graph tests', () => {
	...
	expect(g.get('adj').get(0).get(0)).toBe(1);
	expect(g.get('adj').get(1).get(0)).toBe(0);
    });
	...
	expect(listListVertices.get(0).size).toBe(3);
	expect(listListVertices.get(1).size).toBe(2);
	expect(listListVertices.get(2).size).toBe(1);
	expect(listListVertices.get(0).get(0)).toBe(10);
	expect(listListVertices.get(1).get(0)).toBe(11);
	expect(listListVertices.get(2).get(0)).toBe(15);
